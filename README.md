...
Author: Islombek Abdurakhmanov (Team: RobustaVision)
Team Members: 220724 Odilova Zulayho & 221011 Jabborova Amina
...
Input: Corrupted images (blur, noise, compression)

Base Model: Pretrained ResNet18

Adapter: Lightweight correction module

Training: Mix clean + corrupted samples

Evaluation: Compare clean vs. corrupted accuracy
...
Limited GPU	Use low batch size on Colab
🗓️ Timeline
Week	Task
...
Deployable on low-power embedded hardware.
...
Rusak et al., A Simple Way to Make Neural Networks Robust Against Diverse Image Corruptions, CVPR 2021

Zhang et al., LoRA: Low-Rank Adaptation for Efficient Fine-Tuning, ICLR 2022

Xu et al., DeepAugment: Mixing Multiple Corruption Spaces, NeurIPS 2021
